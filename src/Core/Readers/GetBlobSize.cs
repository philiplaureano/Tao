...
namespace Tao.Readers
{
    ...
    /// </summary>
    public class GetBlobSize : IFunction<Stream, uint> 
    {
        ...
        /// </summary>
        public GetBlobSize(IFunction<ITuple<Stream, byte>, uint> getBlobSizeFromWord, IFunction<ITuple<Stream, byte>, uint> getBlobSizeFromDoubleWord)
        {
