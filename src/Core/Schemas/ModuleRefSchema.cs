...
{
    /// <summary>
    /// Represents the row schema for the ModuleRef table.
    /// </summary>
    public class ModuleRefRowSchema : BaseRowSchema
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleRefRowSchema"/> class.
        /// </summary>
        public ModuleRefRowSchema() : base(0, 0, 0, 1, 0, 0)
        {
        }
