...
{
    /// <summary>
    /// Represents the row schema for the MethodSpec table.
    /// </summary>
    public class MethodSpecRowSchema : BaseRowSchema
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodSpecRowSchema"/> class.
        /// </summary>
        public MethodSpecRowSchema() : base(0, 0, 0, 0, 1, 0)
        {
        }
